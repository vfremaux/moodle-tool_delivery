...
// Privacy.
$string['privacy:metadata'] = "The Code Delivery tool does not store any data belonging to users";
...
$string['configprodtostaging'] = 'Prod to staging sql';
$string['configprodtostaging_desc'] = 'A set of SQL queries to be executed when shifting (reloading) a staging environment with production data. Separate each query with an empty line.';
$string['configstagingtoprod'] = 'Staging to prod sql';
$string['configstagingtoprod_desc'] = 'A set of SQL queries to be executed when shifting (reloading) a production environment with staging data. Separate each query with an empty line.';
...
$string['environmentswitch'] = 'Environment switch';
