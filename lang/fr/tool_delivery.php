...
$string['configprodtostaging'] = 'Production vers qualification (SQL)';
$string['configprodtostaging_desc'] = 'Un lot de requêtes SQL à exécuter après rechargement des données de qualification par les données de production. Séparer chaque requête par une ligne vide.';
$string['configstagingtosprod'] = 'Qualification vers production (SQL)';
$string['configstagingtoprod_desc'] = 'Un lot de requêtes SQL à exécuter après rechargement des données de production par les données de qualification. Séparer chaque requête par une ligne vide.';
...
$string['environmentswitch'] = 'Commutation d\'environnement';
